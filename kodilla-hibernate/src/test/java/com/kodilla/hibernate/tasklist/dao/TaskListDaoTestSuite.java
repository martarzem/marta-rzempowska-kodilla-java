...
public class TaskListDaoTestSuite {
    ...
    private static final String LISTNAME = "Testing TaskList";
    @Autowired
    ...
    public void testTaskListDaoSaveWithTasks() {
        //Given
        //dwa obiekty typu Task
        Task task = new Task("Test: Learn Hibernate", 14);
        Task task2 = new Task("Test: Write some entities", 3);
        //do obiektów tworzymy korespondujące z nimi obiekty typu TaskFinancielDetails
        TaskFinancialDetails tfd = new TaskFinancialDetails(new BigDecimal(20), false);
        TaskFinancialDetails tfd2 = new TaskFinancialDetails(new BigDecimal(10), false);
        task.setTaskFinancialDetails(tfd);
        task2.setTaskFinancialDetails(tfd2);
        //dodawanie obiektów Task do listy TaskList
        TaskList taskList = new TaskList(LISTNAME, "ToDo tasks");
        taskList.getTasks().add(task);
        taskList.getTasks().add(task2);
        //ustawiamy pole taskList w obiektach task i task2
        task.setTaskList(taskList);
        task2.setTaskList(taskList);

        //When
        //zapisanie do bazy danych i zapamiętanie id
        taskListDao.save(taskList);
    ...
    public void testNamedQueries() {
        ...
        //When
        //wywołanie metod beana taskDao, który jest kontrolerem repozytorium
